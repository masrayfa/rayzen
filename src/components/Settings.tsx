...
interface SettingsProps {
  ...
  // Tambah props untuk organization actions
...
const Settings: Component<SettingsProps> = (props) => {
  ...
  const handleUpdateWorkspace = async (id: number) => {
    ...
    try {
      // Di sini Anda perlu menambahkan handler untuk update workspace
      // atau pass sebagai props dari App component
...
//                               size="sm"
//                               onclick={() => handleOrganizationSelect(org.id)}
//                               disabled={selectedOrganizationId() === org.id}
//                               class={
